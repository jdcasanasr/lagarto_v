...
(
	...
	always @(*) 
		begin
			...
			decode_instr_o[357-:64] 		= decode_i[`pc_msb:`pc_lsb];
			decode_instr_o[293-:66] 		= decode_i[`branch_prediction_msb:`branch_prediction_lsb];
			
			decode_instr_o[358] 			= decode_i[`valid_bit];
			
			decode_instr_o[98-:5] 			= decode_i[`rs1_msb:`rs1_lsb];
			decode_instr_o[93-:5] 			= decode_i[`rs2_msb:`rs2_lsb];
			decode_instr_o[88-:5] 			= decode_i[`rd_msb:`rd_lsb];
			...
			decode_instr_o[3-:3] 			= decode_i[`funct3_msb:`funct3_lsb];
		...
		if (!decode_i[`exception_bit] && decode_i[`valid_bit])
		...
		if (!`exception_bit)
			if (xcpt_addr_misaligned_int)
				begin
					...
					decode_instr_o[227-:64] = sv2v_cast_93998(64'b0);
			...
			decode_instr_o[227-:129] = decode_i[`exception_vector_msb:`exception_vector_lsb];
